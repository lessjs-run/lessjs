...
`,
  ...
  "imports": {
    ...
    "@lessjs/core/html-escape": "jsr:@lessjs/core@^${v.core}/html-escape",
    "@lessjs/core/navigation": "jsr:@lessjs/core@^${v.core}/navigation",
    "@lessjs/core/render-dsd": "jsr:@lessjs/core@^${v.core}/render-dsd",
    "@lessjs/core/ssr-handler": "jsr:@lessjs/core@^${v.core}/ssr-handler",
