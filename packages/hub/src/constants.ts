// v0.29.6: Centralized constants for hub package.
// All hardcoded versions, versions, and paths are defined here.

/** Version of the hub validator that produced the hub data */
export const VALIDATOR_VERSION = '0.29.6';

/** Version of @shoelace-style/shoelace used in hub snapshots */
export const SHOELACE_VERSION = '2.20.1';

/** Version of @lessjs/ui recorded in hub scanner */
export const LESSJS_UI_VERSION = '0.29.6';
