...
`,
  ...
  "imports": {
    ...
    "@kissjs/core": "jsr:@kissjs/core@^0.5.3",
    "@kissjs/core/kiss-runtime": "jsr:@kissjs/core@^0.5.3/kiss-runtime",
    "@kissjs/ui": "jsr:@kissjs/ui@^0.5.2",
    "@kissjs/ui/tokens/colors": "jsr:@kissjs/ui@^0.5.2/tokens/colors",
    "@kissjs/ui/": "jsr:@kissjs/ui@^0.5.2/"
  },
  "nodeModulesDir": "auto",
  "tasks": {
...
const kissUiAliases = {
  '@kissjs/ui': 'https://jsr.io/@kissjs/ui/0.5.2/src/index.ts',
  '@kissjs/ui/design-tokens': 'https://jsr.io/@kissjs/ui/0.5.2/src/design-tokens.ts',
  '@kissjs/ui/kiss-button': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-button.ts',
  '@kissjs/ui/kiss-card': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-card.ts',
  '@kissjs/ui/kiss-code-block': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-code-block.ts',
  '@kissjs/ui/kiss-hero-ping': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-hero-ping.ts',
  '@kissjs/ui/kiss-input': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-input.ts',
  '@kissjs/ui/kiss-layout': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-layout.ts',
  '@kissjs/ui/kiss-theme-toggle': 'https://jsr.io/@kissjs/ui/0.5.2/src/kiss-theme-toggle.ts',
  '@kissjs/ui/tokens/colors': 'https://jsr.io/@kissjs/ui/0.5.2/src/tokens/colors.ts',
};
