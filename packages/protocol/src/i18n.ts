/**
 * @openelement/protocol/i18n - Locale-aware path types and utilities.
 *
 * Zero-dependency pure TypeScript — safe for protocol.
 * Shared by @openelement/router and @openelement/app/i18n.
 */
