...
| —    | Route Manifest / EntryDescriptor Contract                | Pending (v0.37.5 protocol migration prerequisite) |
...
- **EntryDescriptor route manifest contract** (required before v0.37.5 protocol
  type migration).
