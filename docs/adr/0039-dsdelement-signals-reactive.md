...
LessJS already has `@openelement/signal` — a fine-grained reactive primitive
...
- `@openelement/signal` package usage expanded — validates its design
...
- `@openelement/signal`: Signal/SignalObject implementation
