...
- __data-_ protocol dependency_*: Hydration relies on HTML attributes that must be correctly generated by `renderToString()`. SSR output must match CSR expectations.
