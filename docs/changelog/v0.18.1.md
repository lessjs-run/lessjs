...
### Core Validation Module (`@openelement/core/validate-manifest`)
...
deno run -A jsr:@openelement/core/cli/validate-manifest ./custom-elements.json

# Machine-readable JSON
deno run -A jsr:@openelement/core/cli/validate-manifest ./custom-elements.json --json

# Strict mode (fails on warnings too)
deno run -A jsr:@openelement/core/cli/validate-manifest ./custom-elements.json --strict
```
...
- `@openelement/core/validate-manifest` — validation module
- `@openelement/core/cli/validate-manifest` — CLI entry point
...
- New optional subpath exports: `@openelement/core/validate-manifest`, `@openelement/core/cli/validate-manifest`
