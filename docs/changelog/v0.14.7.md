...
| Package                     | Version |
| --------------------------- | ------- |
| `@openelement/adapter-lit`  | 0.14.7  |
| `@openelement/adapter-vite` | 0.14.7  |
| `@openelement/app`          | 0.14.7  |
| `@openelement/content`      | 0.14.7  |
| `@openelement/core`         | 0.14.7  |
| `@openelement/create`       | 0.14.7  |
| `@openelement/i18n`         | 0.14.7  |
| `@openelement/rpc`          | 0.14.7  |
| `@openelement/signals`      | 0.14.7  |
| `@openelement/ui`           | 0.14.7  |
