...
| v0.17.4 | [v0.17.4-compatibility-boundary-hardening.md](./v0.17.4-compatibility-boundary-hardening.md) | Next         | SSR admission planner              |
| v0.18.0 | [v0.18.0-universal-wc-engine.md](./v0.18.0-universal-wc-engine.md)                           | Planned      | CEM parser and tiers               |
| v0.18.1 | [v0.18.1-validate-manifest-cli.md](./v0.18.1-validate-manifest-cli.md)                       | Planned      | Validation CLI                     |
| v0.18.2 | [v0.18.2-less-add-install-flow.md](./v0.18.2-less-add-install-flow.md)                       | Planned      | Safe add/install flow              |
| v0.18.3 | [v0.18.3-dom-simulation-experiment.md](./v0.18.3-dom-simulation-experiment.md)               | Experimental | Opt-in DOM simulation              |
| v0.19.0 | [v0.19.0-platform-hub.md](./v0.19.0-platform-hub.md)                                         | Planned      | Hub ingestion MVP                  |
| v0.19.1 | [v0.19.1-hub-previews-quality-gates.md](./v0.19.1-hub-previews-quality-gates.md)             | Planned      | Hub previews and scores            |
