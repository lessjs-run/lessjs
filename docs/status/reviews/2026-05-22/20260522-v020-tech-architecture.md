...
*本审核基于 LessJS v0.20.0 源码全量阅读，涵盖 packages/core、packages/signals、packages/ui、packages/adapter-{lit,vanilla,react,vite} 的全部核心源文件，以及 deno.json 配置和 docs/adr/ 下的 12 个架构决策记录。*
