    ...
    return html`
      <less-layout .navItems="${navSections}" .headerNav="${headerNav}" currentPath="/guide/content-system">
        <div class="container">
          ...
          <p class="subtitle">
            <span class="inline-code">@lessjs/content</span> 是 LessJS 的统一内容插件（博客 + 导航 +
            站点地图）。 把 <span class="inline-code">.md</span>
          ...
          ><pre><code>// vite.config.ts
            ...
            <h2>Markdown 文件</h2>
            <p>
              内容目录中的每个 <span class="inline-code">.md</span> 文件自动成为一篇博客文章。 Frontmatter
              支持 <span class="inline-code">title</span>、<span class="inline-code">date</span>、
              <span class="inline-code">tags</span>、<span class="inline-code">draft</span> 和
              <span class="inline-code">excerpt</span>：
            </p>
            <less-code-block
            ><pre><code>&lt;!-- content/blog/2026-05-08-hello-world.md --&gt;
              ---
              title: 'Hello World'
              date: '2026-05-08'
              tags: ['lessjs', 'meta']
              ...
              This is my first post.</code></pre></less-code-block>
              ...
              <ul>
                <li>
                  <span class="inline-code">blog</span> — 博客配置：<span class="inline-code"
                  >{ contentDir, basePath }</span>
                </li>
                <li>
                  <span class="inline-code">nav</span> — 导航配置：<span class="inline-code"
                  >{ routesDir, headerNav }</span>，从路由文件 <span class="inline-code"
                  >export const meta</span> 自动生成侧边栏
                </li>
                <li>
                  <span class="inline-code">sitemap</span> — 站点地图配置：<span class="inline-code"
                  >{ hostname, exclude? }</span>，SSG 完成后自动生成 sitemap.xml + robots.txt
                </li>
              </ul>
              ...
              <p>
                解析 Markdown 文件（含 gray-matter frontmatter）。 返回 <span class="inline-code"
                >{ frontmatter, content, html, slug }</span>。
              </p>
              ...
              <p>
                v0.8 范围：<span class="inline-code">.md → 路由 → 列表/文章页</span> + 导航自动生成 +
                站点地图。 暂不支持 MDX、评论、分页和标签系统。
              </p>
