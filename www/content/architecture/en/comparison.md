...
<p class="subtitle">
LessJS is a DSD-first Web Components application framework. This comparison
...
<tr>
<td>Positioning</td>
<td class="lessjs-col">DSD-first WC Framework</td>
...
<tr>
<td>WC Native</td>
<td class="lessjs-col"><span class="tag-yes">DSD first-class</span></td>
...
<td class="lessjs-col">Lit / React / Vanilla coexist</td>
...
<tr>
<td>Registry Hub</td>
<td class="lessjs-col"><span class="tag-yes">Built-in</span></td>
<td><span class="tag-no">No</span></td>
<td><span class="tag-no">No</span></td>
<td><span class="tag-no">No</span></td>
</tr>
...
<td class="lessjs-col">3-layer (DSD/Island) + multi-adapter</td>
<td>Islands only</td>
<td>Islands only</td>
...
<tr>
<td>Render Timing</td>
<td class="lessjs-col">SSG / ISR (planned) / SSR (planned)</td>
<td>SSG / SSR</td>
<td>SSR</td>
<td>SSR / SSG</td>
</tr>
...
<h2>LessJS Three-Pillar Differentiation</h2>
<ul>
...
<ul>
<li><strong>All-in-one meta-framework</strong> - LessJS's three pillars each have independent value, not a platform that does everything.</li>
