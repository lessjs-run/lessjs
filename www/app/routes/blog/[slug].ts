...
export default class BlogPostPage extends LitElement {
  ...
  static override styles = [pageStyles, css`
    ...
    .blog-content { font-size: 0.9375rem; line-height: 1.75; color: var(--less-text-secondary); }
    .blog-content h2 { margin-top: 2.5rem; color: var(--less-text-primary); font-size: 1.125rem; font-weight: 600; }
    .blog-content h3 { margin-top: 2rem; color: var(--less-text-primary); font-size: 1rem; font-weight: 600; }
    ...
    .blog-content strong { color: var(--less-text-primary); }
    .blog-content code { background: var(--less-code-bg); padding: 0.125rem 0.375rem; border-radius: 2px; font-size: 0.8125rem; font-family: "SF Mono", monospace; }
    .blog-content pre { background: var(--less-bg-surface); border: 0.5px solid var(--less-border); border-radius: 4px; padding: 1rem; overflow-x: auto; margin: 1rem 0; }
    ...
    .blog-content th, .blog-content td { padding: 0.5rem 0.75rem; text-align: left; border-bottom: 0.5px solid var(--less-border); }
    .blog-content th { background: var(--less-bg-surface); color: var(--less-text-muted); font-weight: 600; font-size: 0.6875rem; text-transform: uppercase; letter-spacing: 0.06em; }
    .blog-content a { color: var(--less-accent); text-decoration: none; }
    .blog-content a:hover { text-decoration: underline; }
    .blog-content hr { border: none; border-top: 0.5px solid var(--less-border); margin: 2rem 0; }
