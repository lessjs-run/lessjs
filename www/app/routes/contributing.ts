...
export class ContributingPage extends LitElement {
  ...
  private _renderZh() { return html`<less-layout locale="${this.locale||'zh'}" .locales="${['en','zh']}" .navItems="${navSections}" .headerNav="${headerNav}" current-path="/contributing"><div class="container">
...
deno task docs:dev</code></pre></less-code-block>
  ...
  private _renderEn() { return html`<less-layout locale="${this.locale||'en'}" .locales="${['en','zh']}" .navItems="${navSections}" .headerNav="${headerNav}" current-path="/en/contributing"><div class="container">
    <h1>Contributing to LessJS</h1>
