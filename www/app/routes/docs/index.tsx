  ...
  override render() {
    return (
      <div class='shell'>
        ...
        <div class='paths'>
          <a
            class='card card-bordered p-5 text-inherit no-underline hover:border-indigo-5/28'
            href='/guide/getting-started'
          >
            <span class='badge badge-outline mb-3'>Entry</span>
            <h2 class='card-title'>Build an app</h2>
            <p>
              Create a project, write DSD components, add routes, islands, content, i18n, and
              deploy.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p>
              Understand DSD rendering, island architecture, Hono API routes, and the SSG build
              pipeline.
            </p>
          </a>
          <a
            class='card card-bordered p-5 text-inherit no-underline hover:border-indigo-5/28'
            href='/architecture/package-compatibility'
          >
            <span class='badge badge-outline mb-3'>Integrate</span>
            <h2 class='card-title'>Integrate packages</h2>
            <p>
              Publish Web Components to the Hub. Prove compatibility, DSD conformance, and runtime
              behavior.
            </p>
          </a>
          <a
          ...
          >
            ...
            <p>
              Read the package graph, ADR decisions, SOP execution maps, and release gate mechanics.
            </p>
          </a>
        </div>
      </div>
