      ...
      <div class='shell'>
        ...
        <p>
          {isZh
            ...
            : 'The architecture documentation has moved to the new <a href="/architecture">Architecture section</a>.'}
        </p>
        <p>
          {isZh
            ...
            : `openElement ${OPENELEMENT_VERSION} is a 20-package layered architecture with a smaller public product surface: app/create, runtime/core, UI, and protocols. SSG and adapter-vite remain advanced build infrastructure rather than first-run product packages.`}
        </p>
      </div>
    );
  }
