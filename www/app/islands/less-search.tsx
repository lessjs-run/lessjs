...
sheet.replaceSync(`
  ...
  /* v0.27 - fixed overlay above shadow-DOM stacking contexts.
     z-index 99999 ensures it renders above the app-header (z-index 100)
     regardless of nested shadow root containing-block rules. */
  .overlay {
    position: fixed;
    inset: 0;
    z-index: 99999;
