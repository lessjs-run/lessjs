# ADR 0018: Eliminate Plugin Module State — Virtual Data Modules + @deno/vite-plugin
...
- [ADR 0011: 消除最后一个 globalThis 桥接](./0011-eliminate-last-globalthis-via-closebundle.md) — 类似的跨模块空间数据传递问题
- [ADR 0016: 双模式子路径解析](./0016-dual-mode-subpath-resolution.md) — coreResolvePlugin 的当前实现
- [ADR 0017: 框架运行时与构建编排解耦](./0017-separate-runtime-from-build-orchestration.md) — core/adapter-vite 分离
