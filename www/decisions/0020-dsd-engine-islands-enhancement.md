# ADR 0020: DSD 渲染引擎与 Islands 策略增强 — 核心护城河建设
...
- [ADR 0019: 综合改进计划](./0019-post-review-improvement-plan.md) — 本 ADR 的上层战略框架
...
- [ADR 0018: 虚拟模块数据模式](./0018-dev-build-data-consistency-plugin-data-bridge.md) — DevTools Panel 的虚拟模块注入可复用此模式
